...
| `admin/catalog-resource.sql` | `CATALOG_RESOURCE` | `CATALOG_STATEMENT`, `RESOURCE_STATEMENT`, `STARROCKS_PROPERTIES`, `STARROCKS_STATEMENT_CLASSIFIER` |
| `admin/load-task.sql` | `LOAD_EXPORT` | `LOAD_STATEMENT`, `TASK_STATEMENT`, `STARROCKS_STATEMENT_CLASSIFIER` |
| `admin/show-admin.sql` | `ADMINISTRATION` | `ADMIN_STATEMENT`, `STARROCKS_STATEMENT_CLASSIFIER` |
...
| `admin/backup-restore.sql` | `BACKUP_RESTORE` | `BACKUP_RESTORE_STATEMENT`, `STARROCKS_STATEMENT_CLASSIFIER` |
