...
class StarRocksIdeFixtureTest : BasePlatformTestCase() {
    fun testEditorFixtureOpensStarRocksFileAndBuildsPsi() {
        ...
        assertContainsElement(file, StarRocksElementTypes.WITH_CLAUSE)
        assertContainsElement(file, StarRocksElementTypes.CTE_DEFINITION)
        assertContainsElement(file, StarRocksElementTypes.CTE_NAME)
        assertContainsElement(file, StarRocksElementTypes.WINDOW_CLAUSE)
        assertContainsElement(file, StarRocksElementTypes.WINDOW_DEFINITION)
        assertContainsElement(file, StarRocksElementTypes.WINDOW_NAME)
        assertContainsElement(file, StarRocksElementTypes.WINDOW_REFERENCE_NAME)
        assertContainsElement(file, StarRocksElementTypes.SET_OPERATION_CLAUSE)
        assertContainsElement(file, StarRocksElementTypes.SET_OPERATOR)
    }
    ...
    fun testParserMarksTableReferenceNames() {
    ...
    fun testParserUsesStubPsiForTableAndColumnNames() {
    ...
    fun testNamedStubIndexesExposeTableAndColumnNames() {
    ...
    fun testTableReferencesResolveToLocalCreateTableStubs() {
        val file = configureStarRocksText(LOCAL_TABLE_REFERENCE_SQL)
        val scope = GlobalSearchScope.fileScope(project, file.virtualFile)
    ...
    fun testParserMarksTableAliasesAndQualifiedColumnPrefixes() {
        val file = configureStarRocksText(LOCAL_TABLE_REFERENCE_SQL)
    ...
    fun testQualifiedColumnPrefixesResolveToTableAliases() {
        val file = configureStarRocksText(LOCAL_TABLE_REFERENCE_SQL)
    ...
    fun testQualifiedColumnReferencesResolveToLocalCreateTableColumns() {
        val file = configureStarRocksText(LOCAL_TABLE_REFERENCE_SQL)
    ...
    fun testUnqualifiedColumnReferencesResolveToSingleSourceTableColumns() {
    ...
    fun testParserMarksPropertyKeysAndValues() {
    ...
    fun testParserBuildsCreateViewStatementAndResolvesLocalView() {
        ...
        assertContainsElement(file, StarRocksElementTypes.AS_SELECT_QUERY)
    ...
    fun testSyntaxHighlighterFactoryUsesStarRocksHighlightingLexer() {
        ...
        assertContainsHighlight(highlighter, SQL_KEYWORD_TOKEN, SqlColors.SQL_KEYWORD)
    ...
    fun testSemanticAnnotatorHighlightsTablesColumnsAndAliases() {
        val file = configureStarRocksText(LOCAL_TABLE_REFERENCE_SQL)
    ...
    fun testSemanticAnnotatorHighlightsOrderByColumnReferences() {
        val file = configureStarRocksText(ORDER_BY_REFERENCE_SQL)
    ...
    fun testSemanticAnnotatorHighlightsNamedWindows() {
        val file = configureStarRocksText(SET_WINDOW_SQL)
    ...
    fun testSemanticAnnotatorHighlightsSelectAliases() {
        val file = configureStarRocksText(SELECT_ALIAS_SQL)
    ...
    fun testSemanticAnnotatorHighlightsOrderBySelectAliasReferences() {
        val file = configureStarRocksText(SELECT_ALIAS_SQL)

        val highlights = myFixture.doHighlighting()

        assertSemanticHighlightCountAtLeast(highlights, file, "total_amount", SqlColors.SQL_LOCAL_ALIAS, 2)
        assertSemanticHighlightCountAtLeast(highlights, file, "order_key", SqlColors.SQL_LOCAL_ALIAS, 2)
        assertSemanticHighlightCountAtLeast(highlights, file, "gross_amount", SqlColors.SQL_LOCAL_ALIAS, 2)
    }

    fun testSemanticAnnotatorHighlightsPropertyKeys() {
        val file = configureStarRocksText(CREATE_TABLE_WITH_PROPERTIES_SQL)
    ...
    fun testCompletionContributorExposesOfficialBuiltinFunctions() {
    ...
    fun testCompletionContributorSuggestsLocalTablesInFromClause() {
    ...
    fun testCompletionContributorSuggestsVisibleColumnsInSelectClause() {
    ...
    fun testCompletionContributorSuggestsDerivedTableColumns() {
    ...
    fun testCompletionContributorSuggestsPropertiesOnlyInPropertiesClause() {
