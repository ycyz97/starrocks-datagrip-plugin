...
public class StarRocksPropertyKeyImpl extends ASTWrapperPsiElement implements StarRocksPropertyKey {

  public StarRocksPropertyKeyImpl(@NotNull ASTNode node) {
    super(node);
  }
