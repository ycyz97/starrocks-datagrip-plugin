...
public class StarRocksArrayAccessTailImpl extends ASTWrapperPsiElement implements StarRocksArrayAccessTail {

  public StarRocksArrayAccessTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitArrayAccessTail(this);
  }
