...
public class StarRocksJoinConditionClauseImpl extends ASTWrapperPsiElement implements StarRocksJoinConditionClause {

  public StarRocksJoinConditionClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitJoinConditionClause(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksUsingClause getUsingClause() {
    return findChildByClass(StarRocksUsingClause.class);
  }
