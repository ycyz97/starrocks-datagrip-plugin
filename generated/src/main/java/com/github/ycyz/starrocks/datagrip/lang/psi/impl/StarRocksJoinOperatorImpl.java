...
public class StarRocksJoinOperatorImpl extends ASTWrapperPsiElement implements StarRocksJoinOperator {

  public StarRocksJoinOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
