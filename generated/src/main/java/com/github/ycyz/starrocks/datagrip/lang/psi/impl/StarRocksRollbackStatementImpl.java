...
public class StarRocksRollbackStatementImpl extends ASTWrapperPsiElement implements StarRocksRollbackStatement {

  public StarRocksRollbackStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
