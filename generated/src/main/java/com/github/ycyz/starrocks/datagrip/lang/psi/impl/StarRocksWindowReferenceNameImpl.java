...
public class StarRocksWindowReferenceNameImpl extends ASTWrapperPsiElement implements StarRocksWindowReferenceName {

  public StarRocksWindowReferenceNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitWindowReferenceName(this);
  }
