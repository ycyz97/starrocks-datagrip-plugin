...
public class StarRocksResourceReferenceImpl extends ASTWrapperPsiElement implements StarRocksResourceReference {

  public StarRocksResourceReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitResourceReference(this);
  }
