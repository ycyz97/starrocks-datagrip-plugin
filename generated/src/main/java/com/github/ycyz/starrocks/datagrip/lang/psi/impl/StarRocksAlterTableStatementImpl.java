...
public class StarRocksAlterTableStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterTableStatement {

  public StarRocksAlterTableStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksAlterTableAction getAlterTableAction() {
    return findChildByClass(StarRocksAlterTableAction.class);
  }
