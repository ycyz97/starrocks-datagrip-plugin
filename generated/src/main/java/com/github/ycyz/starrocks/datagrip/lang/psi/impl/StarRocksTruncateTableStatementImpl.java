...
public class StarRocksTruncateTableStatementImpl extends ASTWrapperPsiElement implements StarRocksTruncateTableStatement {

  public StarRocksTruncateTableStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitTruncateTableStatement(this);
  }
