...
public class StarRocksQualifiedColumnPrefixImpl extends ASTWrapperPsiElement implements StarRocksQualifiedColumnPrefix {

  public StarRocksQualifiedColumnPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitQualifiedColumnPrefix(this);
  }
