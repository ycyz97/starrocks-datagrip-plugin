...
public class StarRocksCastTypeImpl extends ASTWrapperPsiElement implements StarRocksCastType {

  public StarRocksCastTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCastType(this);
  }
