...
public class StarRocksSetOperatorImpl extends ASTWrapperPsiElement implements StarRocksSetOperator {

  public StarRocksSetOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
