...
public class StarRocksWhereClauseImpl extends ASTWrapperPsiElement implements StarRocksWhereClause {

  public StarRocksWhereClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
