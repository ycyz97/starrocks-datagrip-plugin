...
public class StarRocksQualifyExpressionImpl extends ASTWrapperPsiElement implements StarRocksQualifyExpression {

  public StarRocksQualifyExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitQualifyExpression(this);
  }
