...
public class StarRocksQualifiedIdentifierImpl extends ASTWrapperPsiElement implements StarRocksQualifiedIdentifier {

  public StarRocksQualifiedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
