...
public class StarRocksPrivilegeItemImpl extends ASTWrapperPsiElement implements StarRocksPrivilegeItem {

  public StarRocksPrivilegeItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitPrivilegeItem(this);
  }
