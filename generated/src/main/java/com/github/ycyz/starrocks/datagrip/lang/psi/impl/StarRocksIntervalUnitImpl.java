...
public class StarRocksIntervalUnitImpl extends ASTWrapperPsiElement implements StarRocksIntervalUnit {

  public StarRocksIntervalUnitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitIntervalUnit(this);
  }
