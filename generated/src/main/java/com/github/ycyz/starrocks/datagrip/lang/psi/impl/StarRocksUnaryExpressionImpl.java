...
public class StarRocksUnaryExpressionImpl extends ASTWrapperPsiElement implements StarRocksUnaryExpression {

  public StarRocksUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksPostfixExpression getPostfixExpression() {
    return findNotNullChildByClass(StarRocksPostfixExpression.class);
  }
