...
public class StarRocksSecurityPrincipalImpl extends ASTWrapperPsiElement implements StarRocksSecurityPrincipal {

  public StarRocksSecurityPrincipalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitSecurityPrincipal(this);
  }
