...
public class StarRocksKillStatementImpl extends ASTWrapperPsiElement implements StarRocksKillStatement {

  public StarRocksKillStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
