...
public class StarRocksRoutineLoadClauseImpl extends ASTWrapperPsiElement implements StarRocksRoutineLoadClause {

  public StarRocksRoutineLoadClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitRoutineLoadClause(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksColumnsClause getColumnsClause() {
    return findChildByClass(StarRocksColumnsClause.class);
  }

  @Override
  @Nullable
  public StarRocksFromKafkaClause getFromKafkaClause() {
    return findChildByClass(StarRocksFromKafkaClause.class);
  }
