...
public class StarRocksPropertiesClauseImpl extends ASTWrapperPsiElement implements StarRocksPropertiesClause {

  public StarRocksPropertiesClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitPropertiesClause(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksPropertyList getPropertyList() {
    return findChildByClass(StarRocksPropertyList.class);
  }
