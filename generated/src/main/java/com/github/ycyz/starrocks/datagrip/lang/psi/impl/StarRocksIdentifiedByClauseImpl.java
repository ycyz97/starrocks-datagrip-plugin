...
public class StarRocksIdentifiedByClauseImpl extends ASTWrapperPsiElement implements StarRocksIdentifiedByClause {

  public StarRocksIdentifiedByClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitIdentifiedByClause(this);
  }
