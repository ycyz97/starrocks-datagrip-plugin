...
public class StarRocksDelimitedIdentifierImpl extends ASTWrapperPsiElement implements StarRocksDelimitedIdentifier {

  public StarRocksDelimitedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
