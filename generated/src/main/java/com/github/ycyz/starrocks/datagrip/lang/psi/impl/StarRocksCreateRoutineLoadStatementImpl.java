...
public class StarRocksCreateRoutineLoadStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateRoutineLoadStatement {

  public StarRocksCreateRoutineLoadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateRoutineLoadStatement(this);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksRoutineLoadClause> getRoutineLoadClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksRoutineLoadClause.class);
  }
