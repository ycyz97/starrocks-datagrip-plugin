...
public class StarRocksRevokeStatementImpl extends ASTWrapperPsiElement implements StarRocksRevokeStatement {

  public StarRocksRevokeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
