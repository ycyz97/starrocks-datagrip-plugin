...
public class StarRocksAdditiveExpressionImpl extends ASTWrapperPsiElement implements StarRocksAdditiveExpression {

  public StarRocksAdditiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksMultiplicativeExpression> getMultiplicativeExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksMultiplicativeExpression.class);
  }
