...
public class StarRocksCancelLoadStatementImpl extends ASTWrapperPsiElement implements StarRocksCancelLoadStatement {

  public StarRocksCancelLoadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCancelLoadStatement(this);
  }
