...
public class StarRocksSelectClauseImpl extends ASTWrapperPsiElement implements StarRocksSelectClause {

  public StarRocksSelectClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksSelectItem> getSelectItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksSelectItem.class);
  }
