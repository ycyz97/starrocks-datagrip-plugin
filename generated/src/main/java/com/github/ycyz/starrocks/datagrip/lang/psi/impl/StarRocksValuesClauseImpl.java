...
public class StarRocksValuesClauseImpl extends ASTWrapperPsiElement implements StarRocksValuesClause {

  public StarRocksValuesClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksValuesRow> getValuesRowList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksValuesRow.class);
  }
