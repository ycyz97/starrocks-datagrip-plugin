...
public class StarRocksLimitClauseImpl extends ASTWrapperPsiElement implements StarRocksLimitClause {

  public StarRocksLimitClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksLimitExpression> getLimitExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksLimitExpression.class);
  }
