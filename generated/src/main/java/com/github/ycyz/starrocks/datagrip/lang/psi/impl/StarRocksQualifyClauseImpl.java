...
public class StarRocksQualifyClauseImpl extends ASTWrapperPsiElement implements StarRocksQualifyClause {

  public StarRocksQualifyClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitQualifyClause(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksQualifyExpression getQualifyExpression() {
    return findChildByClass(StarRocksQualifyExpression.class);
  }
