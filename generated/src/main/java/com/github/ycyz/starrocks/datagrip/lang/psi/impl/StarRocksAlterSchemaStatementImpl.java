...
public class StarRocksAlterSchemaStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterSchemaStatement {

  public StarRocksAlterSchemaStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAlterSchemaStatement(this);
  }
