...
public class StarRocksOrExpressionImpl extends ASTWrapperPsiElement implements StarRocksOrExpression {

  public StarRocksOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksAndExpression> getAndExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksAndExpression.class);
  }
