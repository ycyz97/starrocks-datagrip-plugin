...
public class StarRocksTableAliasColumnNameImpl extends ASTWrapperPsiElement implements StarRocksTableAliasColumnName {

  public StarRocksTableAliasColumnNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitTableAliasColumnName(this);
  }
