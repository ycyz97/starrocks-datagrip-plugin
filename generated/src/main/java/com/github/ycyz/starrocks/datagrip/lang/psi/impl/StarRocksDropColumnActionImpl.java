...
public class StarRocksDropColumnActionImpl extends ASTWrapperPsiElement implements StarRocksDropColumnAction {

  public StarRocksDropColumnActionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropColumnAction(this);
  }
