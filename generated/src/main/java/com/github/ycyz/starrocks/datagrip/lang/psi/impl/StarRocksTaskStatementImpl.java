...
public class StarRocksTaskStatementImpl extends ASTWrapperPsiElement implements StarRocksTaskStatement {

  public StarRocksTaskStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
