...
public class StarRocksRenameActionImpl extends ASTWrapperPsiElement implements StarRocksRenameAction {

  public StarRocksRenameActionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitRenameAction(this);
  }
