...
public class StarRocksStringLiteralImpl extends ASTWrapperPsiElement implements StarRocksStringLiteral {

  public StarRocksStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
