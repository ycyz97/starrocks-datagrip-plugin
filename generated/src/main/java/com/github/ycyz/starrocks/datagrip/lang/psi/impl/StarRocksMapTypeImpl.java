...
public class StarRocksMapTypeImpl extends ASTWrapperPsiElement implements StarRocksMapType {

  public StarRocksMapTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksTypeElement> getTypeElementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksTypeElement.class);
  }
