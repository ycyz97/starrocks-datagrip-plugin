...
public class StarRocksDropTableStatementImpl extends ASTWrapperPsiElement implements StarRocksDropTableStatement {

  public StarRocksDropTableStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
