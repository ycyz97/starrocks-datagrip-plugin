...
public class StarRocksTableReferenceNameImpl extends ASTWrapperPsiElement implements StarRocksTableReferenceName {

  public StarRocksTableReferenceNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitTableReferenceName(this);
  }
