...
public class StarRocksSetPropertiesActionImpl extends ASTWrapperPsiElement implements StarRocksSetPropertiesAction {

  public StarRocksSetPropertiesActionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitSetPropertiesAction(this);
  }
  ...
  public StarRocksPropertiesClause getPropertiesClause() {
    return findNotNullChildByClass(StarRocksPropertiesClause.class);
  }
