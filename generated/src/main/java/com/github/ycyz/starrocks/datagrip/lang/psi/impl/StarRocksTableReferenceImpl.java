...
public class StarRocksTableReferenceImpl extends ASTWrapperPsiElement implements StarRocksTableReference {

  public StarRocksTableReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksTableReferenceName getTableReferenceName() {
    return findNotNullChildByClass(StarRocksTableReferenceName.class);
  }
