...
public class StarRocksIndexReferenceImpl extends ASTWrapperPsiElement implements StarRocksIndexReference {

  public StarRocksIndexReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
