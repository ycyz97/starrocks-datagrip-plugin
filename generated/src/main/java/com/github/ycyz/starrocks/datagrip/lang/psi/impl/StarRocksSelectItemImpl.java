...
public class StarRocksSelectItemImpl extends ASTWrapperPsiElement implements StarRocksSelectItem {

  public StarRocksSelectItemImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksSelectAlias getSelectAlias() {
    return findChildByClass(StarRocksSelectAlias.class);
  }
