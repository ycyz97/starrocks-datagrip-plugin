...
public class StarRocksPartitionClauseImpl extends ASTWrapperPsiElement implements StarRocksPartitionClause {

  public StarRocksPartitionClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksPartitionExpression getPartitionExpression() {
    return findChildByClass(StarRocksPartitionExpression.class);
  }
