...
public class StarRocksCreateRepositoryStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateRepositoryStatement {

  public StarRocksCreateRepositoryStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateRepositoryStatement(this);
  }
