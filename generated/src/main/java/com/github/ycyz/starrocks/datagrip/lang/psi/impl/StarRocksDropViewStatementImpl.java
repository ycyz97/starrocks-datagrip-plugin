...
public class StarRocksDropViewStatementImpl extends ASTWrapperPsiElement implements StarRocksDropViewStatement {

  public StarRocksDropViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
