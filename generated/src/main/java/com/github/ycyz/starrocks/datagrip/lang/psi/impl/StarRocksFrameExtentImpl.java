...
public class StarRocksFrameExtentImpl extends ASTWrapperPsiElement implements StarRocksFrameExtent {

  public StarRocksFrameExtentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitFrameExtent(this);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksFrameBound> getFrameBoundList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksFrameBound.class);
  }
