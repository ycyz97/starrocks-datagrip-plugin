...
public class StarRocksAsSelectClauseImpl extends ASTWrapperPsiElement implements StarRocksAsSelectClause {

  public StarRocksAsSelectClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAsSelectClause(this);
  }
