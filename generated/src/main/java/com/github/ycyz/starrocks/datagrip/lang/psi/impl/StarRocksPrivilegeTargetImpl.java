...
public class StarRocksPrivilegeTargetImpl extends ASTWrapperPsiElement implements StarRocksPrivilegeTarget {

  public StarRocksPrivilegeTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitPrivilegeTarget(this);
  }
