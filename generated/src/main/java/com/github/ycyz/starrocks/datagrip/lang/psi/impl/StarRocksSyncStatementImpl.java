...
public class StarRocksSyncStatementImpl extends ASTWrapperPsiElement implements StarRocksSyncStatement {

  public StarRocksSyncStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
