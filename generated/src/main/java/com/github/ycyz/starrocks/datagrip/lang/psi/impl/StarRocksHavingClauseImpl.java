...
public class StarRocksHavingClauseImpl extends ASTWrapperPsiElement implements StarRocksHavingClause {

  public StarRocksHavingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
