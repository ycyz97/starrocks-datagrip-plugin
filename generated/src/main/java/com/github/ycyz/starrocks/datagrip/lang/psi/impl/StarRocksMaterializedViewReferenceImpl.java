...
public class StarRocksMaterializedViewReferenceImpl extends ASTWrapperPsiElement implements StarRocksMaterializedViewReference {

  public StarRocksMaterializedViewReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitMaterializedViewReference(this);
  }
