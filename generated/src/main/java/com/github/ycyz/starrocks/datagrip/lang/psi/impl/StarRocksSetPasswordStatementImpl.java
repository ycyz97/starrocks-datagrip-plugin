...
public class StarRocksSetPasswordStatementImpl extends ASTWrapperPsiElement implements StarRocksSetPasswordStatement {

  public StarRocksSetPasswordStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitSetPasswordStatement(this);
  }
