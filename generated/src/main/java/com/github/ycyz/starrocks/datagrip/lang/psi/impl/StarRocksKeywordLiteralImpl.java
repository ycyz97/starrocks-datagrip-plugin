...
public class StarRocksKeywordLiteralImpl extends ASTWrapperPsiElement implements StarRocksKeywordLiteral {

  public StarRocksKeywordLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
