...
public class StarRocksCreateViewStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateViewStatement {

  public StarRocksCreateViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
