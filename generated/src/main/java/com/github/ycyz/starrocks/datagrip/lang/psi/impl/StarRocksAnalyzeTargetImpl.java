...
public class StarRocksAnalyzeTargetImpl extends ASTWrapperPsiElement implements StarRocksAnalyzeTarget {

  public StarRocksAnalyzeTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAnalyzeTarget(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksAnalyzeColumnList getAnalyzeColumnList() {
    return findChildByClass(StarRocksAnalyzeColumnList.class);
  }
