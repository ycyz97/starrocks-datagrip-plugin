...
public class StarRocksCreateCatalogStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateCatalogStatement {

  public StarRocksCreateCatalogStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateCatalogStatement(this);
  }
