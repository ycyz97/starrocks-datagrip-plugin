...
public class StarRocksPropertyValueImpl extends ASTWrapperPsiElement implements StarRocksPropertyValue {

  public StarRocksPropertyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
