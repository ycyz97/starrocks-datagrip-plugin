...
public class StarRocksAlterRoutineLoadStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterRoutineLoadStatement {

  public StarRocksAlterRoutineLoadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAlterRoutineLoadStatement(this);
  }
