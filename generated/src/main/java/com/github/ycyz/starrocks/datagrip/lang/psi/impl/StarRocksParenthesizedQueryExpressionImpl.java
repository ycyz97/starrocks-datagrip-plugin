...
public class StarRocksParenthesizedQueryExpressionImpl extends ASTWrapperPsiElement implements StarRocksParenthesizedQueryExpression {

  public StarRocksParenthesizedQueryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitParenthesizedQueryExpression(this);
  }
  ...
  public StarRocksQueryExpression getQueryExpression() {
    return findNotNullChildByClass(StarRocksQueryExpression.class);
  }
