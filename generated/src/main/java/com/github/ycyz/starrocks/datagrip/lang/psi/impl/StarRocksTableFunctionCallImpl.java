...
public class StarRocksTableFunctionCallImpl extends ASTWrapperPsiElement implements StarRocksTableFunctionCall {

  public StarRocksTableFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitTableFunctionCall(this);
  }
