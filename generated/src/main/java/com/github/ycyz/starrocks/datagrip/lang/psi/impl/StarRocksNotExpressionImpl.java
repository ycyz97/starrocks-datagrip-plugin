...
public class StarRocksNotExpressionImpl extends ASTWrapperPsiElement implements StarRocksNotExpression {

  public StarRocksNotExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksComparisonExpression getComparisonExpression() {
    return findNotNullChildByClass(StarRocksComparisonExpression.class);
  }
