...
public class StarRocksOrderingItemImpl extends ASTWrapperPsiElement implements StarRocksOrderingItem {

  public StarRocksOrderingItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitOrderingItem(this);
  }
