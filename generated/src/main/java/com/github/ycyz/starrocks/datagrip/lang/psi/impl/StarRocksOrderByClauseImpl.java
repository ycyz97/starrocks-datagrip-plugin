...
public class StarRocksOrderByClauseImpl extends ASTWrapperPsiElement implements StarRocksOrderByClause {

  public StarRocksOrderByClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksOrderingItem> getOrderingItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksOrderingItem.class);
  }
