...
public class StarRocksPropertyListImpl extends ASTWrapperPsiElement implements StarRocksPropertyList {

  public StarRocksPropertyListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksPropertyPair> getPropertyPairList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksPropertyPair.class);
  }
