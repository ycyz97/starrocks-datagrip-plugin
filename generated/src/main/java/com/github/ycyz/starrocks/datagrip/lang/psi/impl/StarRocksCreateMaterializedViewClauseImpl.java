...
public class StarRocksCreateMaterializedViewClauseImpl extends ASTWrapperPsiElement implements StarRocksCreateMaterializedViewClause {

  public StarRocksCreateMaterializedViewClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateMaterializedViewClause(this);
  }
