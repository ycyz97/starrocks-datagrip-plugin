...
public class StarRocksUseStatementImpl extends ASTWrapperPsiElement implements StarRocksUseStatement {

  public StarRocksUseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksUseTarget getUseTarget() {
    return findChildByClass(StarRocksUseTarget.class);
  }
