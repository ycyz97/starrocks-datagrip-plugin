...
public class StarRocksIntervalExpressionImpl extends ASTWrapperPsiElement implements StarRocksIntervalExpression {

  public StarRocksIntervalExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksIntervalUnit getIntervalUnit() {
    return findNotNullChildByClass(StarRocksIntervalUnit.class);
  }
