...
public class StarRocksDropRoleStatementImpl extends ASTWrapperPsiElement implements StarRocksDropRoleStatement {

  public StarRocksDropRoleStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
