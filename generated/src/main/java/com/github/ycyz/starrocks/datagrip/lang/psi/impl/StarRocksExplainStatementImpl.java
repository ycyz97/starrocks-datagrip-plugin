...
public class StarRocksExplainStatementImpl extends ASTWrapperPsiElement implements StarRocksExplainStatement {

  public StarRocksExplainStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
