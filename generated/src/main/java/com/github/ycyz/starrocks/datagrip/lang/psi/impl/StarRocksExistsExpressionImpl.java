...
public class StarRocksExistsExpressionImpl extends ASTWrapperPsiElement implements StarRocksExistsExpression {

  public StarRocksExistsExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
