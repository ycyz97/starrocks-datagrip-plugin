...
public class StarRocksParenthesizedIdentifierListImpl extends ASTWrapperPsiElement implements StarRocksParenthesizedIdentifierList {

  public StarRocksParenthesizedIdentifierListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitParenthesizedIdentifierList(this);
  }
