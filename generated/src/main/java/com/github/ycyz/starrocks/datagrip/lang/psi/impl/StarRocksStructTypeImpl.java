...
public class StarRocksStructTypeImpl extends ASTWrapperPsiElement implements StarRocksStructType {

  public StarRocksStructTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksStructField> getStructFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksStructField.class);
  }
