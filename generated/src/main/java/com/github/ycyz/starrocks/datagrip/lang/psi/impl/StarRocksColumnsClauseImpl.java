...
public class StarRocksColumnsClauseImpl extends ASTWrapperPsiElement implements StarRocksColumnsClause {

  public StarRocksColumnsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitColumnsClause(this);
  }
