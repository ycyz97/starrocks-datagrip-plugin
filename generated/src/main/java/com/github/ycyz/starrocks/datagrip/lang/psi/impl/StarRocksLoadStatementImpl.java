...
public class StarRocksLoadStatementImpl extends ASTWrapperPsiElement implements StarRocksLoadStatement {

  public StarRocksLoadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
