...
public class StarRocksCallStatementImpl extends ASTWrapperPsiElement implements StarRocksCallStatement {

  public StarRocksCallStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
