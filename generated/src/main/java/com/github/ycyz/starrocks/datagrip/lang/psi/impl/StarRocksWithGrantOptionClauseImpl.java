...
public class StarRocksWithGrantOptionClauseImpl extends ASTWrapperPsiElement implements StarRocksWithGrantOptionClause {

  public StarRocksWithGrantOptionClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitWithGrantOptionClause(this);
  }
