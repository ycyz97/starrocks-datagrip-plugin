...
public class StarRocksCommentClauseImpl extends ASTWrapperPsiElement implements StarRocksCommentClause {

  public StarRocksCommentClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCommentClause(this);
  }
