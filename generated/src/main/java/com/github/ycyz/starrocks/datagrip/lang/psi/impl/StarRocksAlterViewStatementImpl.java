...
public class StarRocksAlterViewStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterViewStatement {

  public StarRocksAlterViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
