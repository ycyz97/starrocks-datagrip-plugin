...
public class StarRocksDescribeStatementImpl extends ASTWrapperPsiElement implements StarRocksDescribeStatement {

  public StarRocksDescribeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksDescribeTarget getDescribeTarget() {
    return findChildByClass(StarRocksDescribeTarget.class);
  }
