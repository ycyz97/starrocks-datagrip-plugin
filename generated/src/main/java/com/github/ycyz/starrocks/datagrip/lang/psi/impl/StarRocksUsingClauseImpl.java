...
public class StarRocksUsingClauseImpl extends ASTWrapperPsiElement implements StarRocksUsingClause {

  public StarRocksUsingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
