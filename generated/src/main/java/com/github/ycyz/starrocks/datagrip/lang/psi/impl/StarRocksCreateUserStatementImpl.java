...
public class StarRocksCreateUserStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateUserStatement {

  public StarRocksCreateUserStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateUserStatement(this);
  }
