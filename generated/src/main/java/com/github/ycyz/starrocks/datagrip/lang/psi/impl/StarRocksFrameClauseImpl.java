...
public class StarRocksFrameClauseImpl extends ASTWrapperPsiElement implements StarRocksFrameClause {

  public StarRocksFrameClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksFrameExtent getFrameExtent() {
    return findNotNullChildByClass(StarRocksFrameExtent.class);
  }
