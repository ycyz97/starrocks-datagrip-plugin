...
public class StarRocksCatalogReferenceImpl extends ASTWrapperPsiElement implements StarRocksCatalogReference {

  public StarRocksCatalogReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCatalogReference(this);
  }
