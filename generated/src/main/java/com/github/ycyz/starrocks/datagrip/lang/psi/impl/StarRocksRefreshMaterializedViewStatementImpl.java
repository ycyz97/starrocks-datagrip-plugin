...
public class StarRocksRefreshMaterializedViewStatementImpl extends ASTWrapperPsiElement implements StarRocksRefreshMaterializedViewStatement {

  public StarRocksRefreshMaterializedViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitRefreshMaterializedViewStatement(this);
  }
