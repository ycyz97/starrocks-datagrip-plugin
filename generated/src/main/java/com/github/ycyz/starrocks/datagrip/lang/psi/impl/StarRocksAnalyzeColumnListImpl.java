...
public class StarRocksAnalyzeColumnListImpl extends ASTWrapperPsiElement implements StarRocksAnalyzeColumnList {

  public StarRocksAnalyzeColumnListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAnalyzeColumnList(this);
  }
  ...
  public StarRocksParenthesizedIdentifierList getParenthesizedIdentifierList() {
    return findNotNullChildByClass(StarRocksParenthesizedIdentifierList.class);
  }
