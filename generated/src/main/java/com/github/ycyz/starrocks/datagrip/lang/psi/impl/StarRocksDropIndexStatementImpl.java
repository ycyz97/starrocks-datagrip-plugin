...
public class StarRocksDropIndexStatementImpl extends ASTWrapperPsiElement implements StarRocksDropIndexStatement {

  public StarRocksDropIndexStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
