...
public class StarRocksRefreshClauseImpl extends ASTWrapperPsiElement implements StarRocksRefreshClause {

  public StarRocksRefreshClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitRefreshClause(this);
  }
