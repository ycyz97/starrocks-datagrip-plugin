...
public class StarRocksFromClauseImpl extends ASTWrapperPsiElement implements StarRocksFromClause {

  public StarRocksFromClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksTableExpression> getTableExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksTableExpression.class);
  }
