...
public class StarRocksParenthesizedJoinExpressionImpl extends ASTWrapperPsiElement implements StarRocksParenthesizedJoinExpression {

  public StarRocksParenthesizedJoinExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitParenthesizedJoinExpression(this);
  }
