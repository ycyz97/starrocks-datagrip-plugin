...
public class StarRocksShowTargetImpl extends ASTWrapperPsiElement implements StarRocksShowTarget {

  public StarRocksShowTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitShowTarget(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksShowCreateTarget getShowCreateTarget() {
    return findChildByClass(StarRocksShowCreateTarget.class);
  }
