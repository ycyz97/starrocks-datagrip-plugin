...
public class StarRocksStructFieldImpl extends ASTWrapperPsiElement implements StarRocksStructField {

  public StarRocksStructFieldImpl(@NotNull ASTNode node) {
    super(node);
  }
