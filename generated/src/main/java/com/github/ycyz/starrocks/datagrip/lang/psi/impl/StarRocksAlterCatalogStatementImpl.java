...
public class StarRocksAlterCatalogStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterCatalogStatement {

  public StarRocksAlterCatalogStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAlterCatalogStatement(this);
  }
