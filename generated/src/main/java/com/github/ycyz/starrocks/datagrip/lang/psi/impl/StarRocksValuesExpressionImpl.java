...
public class StarRocksValuesExpressionImpl extends ASTWrapperPsiElement implements StarRocksValuesExpression {

  public StarRocksValuesExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public StarRocksValuesClause getValuesClause() {
    return findNotNullChildByClass(StarRocksValuesClause.class);
  }
