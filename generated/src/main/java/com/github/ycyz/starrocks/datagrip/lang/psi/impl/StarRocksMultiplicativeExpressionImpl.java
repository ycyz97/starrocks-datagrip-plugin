...
public class StarRocksMultiplicativeExpressionImpl extends ASTWrapperPsiElement implements StarRocksMultiplicativeExpression {

  public StarRocksMultiplicativeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksUnaryExpression> getUnaryExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksUnaryExpression.class);
  }
