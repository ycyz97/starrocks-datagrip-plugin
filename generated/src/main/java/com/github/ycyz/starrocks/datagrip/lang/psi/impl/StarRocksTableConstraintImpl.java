...
public class StarRocksTableConstraintImpl extends ASTWrapperPsiElement implements StarRocksTableConstraint {

  public StarRocksTableConstraintImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksKeyColumnList getKeyColumnList() {
    return findNotNullChildByClass(StarRocksKeyColumnList.class);
  }
