...
public class StarRocksLimitExpressionImpl extends ASTWrapperPsiElement implements StarRocksLimitExpression {

  public StarRocksLimitExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitLimitExpression(this);
  }
