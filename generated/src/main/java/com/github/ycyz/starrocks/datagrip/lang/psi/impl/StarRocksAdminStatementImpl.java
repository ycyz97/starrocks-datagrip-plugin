...
public class StarRocksAdminStatementImpl extends ASTWrapperPsiElement implements StarRocksAdminStatement {

  public StarRocksAdminStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAdminStatement(this);
  }
