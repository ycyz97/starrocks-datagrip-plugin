...
public class StarRocksCreateResourceStatementImpl extends ASTWrapperPsiElement implements StarRocksCreateResourceStatement {

  public StarRocksCreateResourceStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCreateResourceStatement(this);
  }
