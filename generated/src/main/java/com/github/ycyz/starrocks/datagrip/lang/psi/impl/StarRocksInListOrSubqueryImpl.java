...
public class StarRocksInListOrSubqueryImpl extends ASTWrapperPsiElement implements StarRocksInListOrSubquery {

  public StarRocksInListOrSubqueryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitInListOrSubquery(this);
  }
