...
public class StarRocksDropCatalogStatementImpl extends ASTWrapperPsiElement implements StarRocksDropCatalogStatement {

  public StarRocksDropCatalogStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropCatalogStatement(this);
  }
