...
public class StarRocksSchemaReferenceImpl extends ASTWrapperPsiElement implements StarRocksSchemaReference {

  public StarRocksSchemaReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
