...
public class StarRocksColumnReferenceNameImpl extends ASTWrapperPsiElement implements StarRocksColumnReferenceName {

  public StarRocksColumnReferenceNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitColumnReferenceName(this);
  }
