...
public class StarRocksGroupByClauseImpl extends ASTWrapperPsiElement implements StarRocksGroupByClause {

  public StarRocksGroupByClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
