...
public class StarRocksUseTargetImpl extends ASTWrapperPsiElement implements StarRocksUseTarget {

  public StarRocksUseTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitUseTarget(this);
  }
  ...
  public StarRocksSchemaReference getSchemaReference() {
    return findNotNullChildByClass(StarRocksSchemaReference.class);
  }
