...
public class StarRocksMergeWhenClauseImpl extends ASTWrapperPsiElement implements StarRocksMergeWhenClause {

  public StarRocksMergeWhenClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
