...
public class StarRocksWindowClauseImpl extends ASTWrapperPsiElement implements StarRocksWindowClause {

  public StarRocksWindowClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksWindowDefinition> getWindowDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksWindowDefinition.class);
  }
