...
public class StarRocksFieldAccessTailImpl extends ASTWrapperPsiElement implements StarRocksFieldAccessTail {

  public StarRocksFieldAccessTailImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitFieldAccessTail(this);
  }
