...
public class StarRocksAndExpressionImpl extends ASTWrapperPsiElement implements StarRocksAndExpression {

  public StarRocksAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksNotExpression> getNotExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksNotExpression.class);
  }
