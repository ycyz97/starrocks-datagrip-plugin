...
public class StarRocksDefaultRoleClauseImpl extends ASTWrapperPsiElement implements StarRocksDefaultRoleClause {

  public StarRocksDefaultRoleClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDefaultRoleClause(this);
  }
  ...
  public StarRocksSecurityPrincipalList getSecurityPrincipalList() {
    return findNotNullChildByClass(StarRocksSecurityPrincipalList.class);
  }
