...
public class StarRocksCaseElseClauseImpl extends ASTWrapperPsiElement implements StarRocksCaseElseClause {

  public StarRocksCaseElseClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCaseElseClause(this);
  }
