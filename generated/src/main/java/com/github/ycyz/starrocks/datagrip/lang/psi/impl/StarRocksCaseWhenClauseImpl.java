...
public class StarRocksCaseWhenClauseImpl extends ASTWrapperPsiElement implements StarRocksCaseWhenClause {

  public StarRocksCaseWhenClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
