...
public class StarRocksSetStatementImpl extends ASTWrapperPsiElement implements StarRocksSetStatement {

  public StarRocksSetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksSetAssignment> getSetAssignmentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksSetAssignment.class);
  }
