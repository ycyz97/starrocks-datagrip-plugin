...
public class StarRocksKeyColumnImpl extends ASTWrapperPsiElement implements StarRocksKeyColumn {

  public StarRocksKeyColumnImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitKeyColumn(this);
  }
