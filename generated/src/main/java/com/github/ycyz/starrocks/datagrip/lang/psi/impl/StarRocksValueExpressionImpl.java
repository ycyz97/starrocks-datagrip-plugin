...
public class StarRocksValueExpressionImpl extends ASTWrapperPsiElement implements StarRocksValueExpression {

  public StarRocksValueExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public StarRocksOrExpression getOrExpression() {
    return findNotNullChildByClass(StarRocksOrExpression.class);
  }
