...
public class StarRocksTypedLiteralPrefixImpl extends ASTWrapperPsiElement implements StarRocksTypedLiteralPrefix {

  public StarRocksTypedLiteralPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitTypedLiteralPrefix(this);
  }
