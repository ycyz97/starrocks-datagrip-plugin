...
public class StarRocksTypeParametersImpl extends ASTWrapperPsiElement implements StarRocksTypeParameters {

  public StarRocksTypeParametersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<StarRocksNumericLiteral> getNumericLiteralList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, StarRocksNumericLiteral.class);
  }
