...
public class StarRocksBucketsClauseImpl extends ASTWrapperPsiElement implements StarRocksBucketsClause {

  public StarRocksBucketsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitBucketsClause(this);
  }
