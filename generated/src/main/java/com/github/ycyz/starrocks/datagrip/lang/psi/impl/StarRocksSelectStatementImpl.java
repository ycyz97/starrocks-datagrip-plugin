...
public class StarRocksSelectStatementImpl extends ASTWrapperPsiElement implements StarRocksSelectStatement {

  public StarRocksSelectStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
