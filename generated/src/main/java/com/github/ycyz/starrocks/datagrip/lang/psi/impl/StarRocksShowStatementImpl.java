...
public class StarRocksShowStatementImpl extends ASTWrapperPsiElement implements StarRocksShowStatement {

  public StarRocksShowStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksShowTarget getShowTarget() {
    return findChildByClass(StarRocksShowTarget.class);
  }
