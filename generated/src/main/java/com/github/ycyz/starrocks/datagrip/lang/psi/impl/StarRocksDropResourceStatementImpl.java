...
public class StarRocksDropResourceStatementImpl extends ASTWrapperPsiElement implements StarRocksDropResourceStatement {

  public StarRocksDropResourceStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropResourceStatement(this);
  }
