...
public class StarRocksParameterLiteralImpl extends ASTWrapperPsiElement implements StarRocksParameterLiteral {

  public StarRocksParameterLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
