...
public class StarRocksMergeOnClauseImpl extends ASTWrapperPsiElement implements StarRocksMergeOnClause {

  public StarRocksMergeOnClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitMergeOnClause(this);
  }
