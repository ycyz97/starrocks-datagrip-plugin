...
public class StarRocksCteColumnNameImpl extends ASTWrapperPsiElement implements StarRocksCteColumnName {

  public StarRocksCteColumnNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitCteColumnName(this);
  }
