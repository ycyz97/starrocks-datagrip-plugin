...
public class StarRocksBeginStatementImpl extends ASTWrapperPsiElement implements StarRocksBeginStatement {

  public StarRocksBeginStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
