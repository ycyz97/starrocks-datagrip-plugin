...
public class StarRocksSelectAliasImpl extends ASTWrapperPsiElement implements StarRocksSelectAlias {

  public StarRocksSelectAliasImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitSelectAlias(this);
  }
