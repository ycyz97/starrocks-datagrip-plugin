...
public class StarRocksViewReferenceImpl extends ASTWrapperPsiElement implements StarRocksViewReference {

  public StarRocksViewReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitViewReference(this);
  }
