...
public class StarRocksFromKafkaClauseImpl extends ASTWrapperPsiElement implements StarRocksFromKafkaClause {

  public StarRocksFromKafkaClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitFromKafkaClause(this);
  }
