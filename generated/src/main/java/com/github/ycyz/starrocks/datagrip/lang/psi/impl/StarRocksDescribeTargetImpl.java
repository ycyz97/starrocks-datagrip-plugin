...
public class StarRocksDescribeTargetImpl extends ASTWrapperPsiElement implements StarRocksDescribeTarget {

  public StarRocksDescribeTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDescribeTarget(this);
  }
