...
public class StarRocksCommitStatementImpl extends ASTWrapperPsiElement implements StarRocksCommitStatement {

  public StarRocksCommitStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
