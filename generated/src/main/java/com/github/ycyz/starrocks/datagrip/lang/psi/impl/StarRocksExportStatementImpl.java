...
public class StarRocksExportStatementImpl extends ASTWrapperPsiElement implements StarRocksExportStatement {

  public StarRocksExportStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
