...
public class StarRocksAlterUserStatementImpl extends ASTWrapperPsiElement implements StarRocksAlterUserStatement {

  public StarRocksAlterUserStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitAlterUserStatement(this);
  }
