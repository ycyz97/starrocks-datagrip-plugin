...
public class StarRocksDropSchemaStatementImpl extends ASTWrapperPsiElement implements StarRocksDropSchemaStatement {

  public StarRocksDropSchemaStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
