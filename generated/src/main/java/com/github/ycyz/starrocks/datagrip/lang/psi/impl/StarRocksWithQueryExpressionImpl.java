...
public class StarRocksWithQueryExpressionImpl extends ASTWrapperPsiElement implements StarRocksWithQueryExpression {

  public StarRocksWithQueryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitWithQueryExpression(this);
  }
  ...
  @Override
  @NotNull
  public StarRocksWithClause getWithClause() {
    return findNotNullChildByClass(StarRocksWithClause.class);
  }
