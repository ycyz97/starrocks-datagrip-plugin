...
public class StarRocksDropMaterializedViewStatementImpl extends ASTWrapperPsiElement implements StarRocksDropMaterializedViewStatement {

  public StarRocksDropMaterializedViewStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropMaterializedViewStatement(this);
  }
