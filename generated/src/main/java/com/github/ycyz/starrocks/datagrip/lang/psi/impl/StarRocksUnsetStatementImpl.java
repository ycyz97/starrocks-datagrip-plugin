...
public class StarRocksUnsetStatementImpl extends ASTWrapperPsiElement implements StarRocksUnsetStatement {

  public StarRocksUnsetStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitUnsetStatement(this);
  }
