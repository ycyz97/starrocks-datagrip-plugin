...
public class StarRocksDropUserStatementImpl extends ASTWrapperPsiElement implements StarRocksDropUserStatement {

  public StarRocksDropUserStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropUserStatement(this);
  }
