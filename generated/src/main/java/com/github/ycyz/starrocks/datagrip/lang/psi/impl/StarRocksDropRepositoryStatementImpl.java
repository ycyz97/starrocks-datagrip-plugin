...
public class StarRocksDropRepositoryStatementImpl extends ASTWrapperPsiElement implements StarRocksDropRepositoryStatement {

  public StarRocksDropRepositoryStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDropRepositoryStatement(this);
  }
