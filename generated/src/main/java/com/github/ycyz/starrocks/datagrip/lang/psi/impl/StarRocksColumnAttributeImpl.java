...
public class StarRocksColumnAttributeImpl extends ASTWrapperPsiElement implements StarRocksColumnAttribute {

  public StarRocksColumnAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitColumnAttribute(this);
  }
