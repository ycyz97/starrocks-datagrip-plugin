...
public class StarRocksNumericLiteralImpl extends ASTWrapperPsiElement implements StarRocksNumericLiteral {

  public StarRocksNumericLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
