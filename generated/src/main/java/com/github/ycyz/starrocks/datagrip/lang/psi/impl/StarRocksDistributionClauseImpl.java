...
public class StarRocksDistributionClauseImpl extends ASTWrapperPsiElement implements StarRocksDistributionClause {

  public StarRocksDistributionClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull StarRocksVisitor visitor) {
    visitor.visitDistributionClause(this);
  }
  ...
  @Override
  @Nullable
  public StarRocksDistributionExpression getDistributionExpression() {
    return findChildByClass(StarRocksDistributionExpression.class);
  }
