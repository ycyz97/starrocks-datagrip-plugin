...
public class StarRocksUpdateStatementImpl extends ASTWrapperPsiElement implements StarRocksUpdateStatement {

  public StarRocksUpdateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public StarRocksSetClause getSetClause() {
    return findChildByClass(StarRocksSetClause.class);
  }
